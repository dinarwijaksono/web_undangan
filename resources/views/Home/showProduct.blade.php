                ...
                <div class="row justify-content-center">
                    ...
                    <div class="border col-sm-12 col-md-4 m-2 border-2 rounded " style="overflow: hidden;  position: relative; width: 300px; height: 300px; ">
                        ...
                        <?php if ($product['image'] === NULL) : ?>
                            ...
                            <?php else : ?>
                                <div style="background-image: url('/storage/<?= 'tumbs/' . $product['image'] ?>'); background-size: cover; background-position: center; background-repeat: no-repeat; position: absolute; top: 0; bottom: 0; left: 0; right: 0; ">
                                <?php endif ?>
